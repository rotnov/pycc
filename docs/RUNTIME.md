...
| `tuple[...]` carrying anything else, any other container (`frozenset[int]` included), `T \| None` | **not carried**: `C0003` | **not carried**: `C0003` |
