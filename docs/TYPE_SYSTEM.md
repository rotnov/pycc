...
- Everything the class-attribute model rejects anywhere, unchanged: a value-less declaration, a non-scalar type, a non-literal right-hand side, `__slots__`, and the two PEP 591-invalid `Final`/`ClassVar` nestings.
