...
- Record: `site/evidence-heroes.json` `status` is `all-Tier-1` for main
  ...
  2026-09-11T15:26:38Z. The record pins the collector's and its suite's
  canonical SHA-256, so it was re-collected with
  `--collected-at 2026-09-11T15:26:38Z` after the suite changed.
...
21. External, on PR #1008, one Codex P2: the hiding-declaration match saw
    ...
    Cases in all three suites, snapshot re-collected at `2026-09-11T15:26:38Z` with
    `--subject 4111208c`, pins rotated.
