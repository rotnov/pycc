...
| [DECISIONS.md](./DECISIONS.md) | ADR log D-001…D-038 (int repr, LLVM, UTF-8 str, no-GIL model, coverage, agent surfaces, CI trust, iEvo, repository governance, Windows CI, frontend depth…) | irreversible calls |
