...
| `site/evidence-heroes.json` | Versioned evidence-hero inventory, ordered immutable execution transcripts, current scope, unavailable states, and cross-surface projections (D-186, D-230) | `scripts/check-site.sh`, `scripts/test-check-site.sh`, HTML/Markdown/LLM/structured/social projections |
