...
| [DECISIONS.md](./DECISIONS.md) | ADR log D-001…D-021 (int repr, LLVM, UTF-8 str, no-GIL model, coverage, agent surfaces, CI trust, v0.1 runtime bootstrap…) | irreversible calls |
