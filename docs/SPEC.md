...
| [DECISIONS.md](./DECISIONS.md) | ADR log D-001…D-048 (int repr, LLVM, UTF-8 str, no-GIL model, coverage, agent surfaces, CI trust, iEvo, repository governance, Windows CI, roadmap evidence, frontend depth, performance-gate activation…) | irreversible calls |
