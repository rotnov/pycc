...
- Suggestions marked machine-applicable are designed to be applied by a planned `pycc check --fix` flag (not yet implemented, see `docs/CLI_SPEC.md`) and must be idempotent + tested once that flag exists.
