...
|---|---|---|
| `C0001` | error | valid Python construct is not implemented by this pycc version -- e.g. `hash()` of a type CPython hashes but this version does not yet, "`hash()` of `<ty>` is valid Python but not implemented yet" (#1331) |
