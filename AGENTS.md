...
## Keep machine-local hooks local ([D-023](docs/DECISIONS.md#d-023-shared-auto-evolution-intent-with-local-hook-execution), [D-025](docs/DECISIONS.md#d-025-registered-contracts-for-shared-hook-targets), [D-067](docs/DECISIONS.md#d-067-project-local-ievo-hook-lifecycle-is-symmetric))
