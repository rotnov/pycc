...
mutations = (
    ...
    (
        site_dir / "status" / "index.html",
        "This paired gate measures the",
        "This cross-run gate measures the",
        "status page without paired performance measurement",
    ),
    (
        site_dir / "status" / "index.html",
        "exact predecessor and candidate sequentially on one hosted runner",
    ...
    (
        ...
        "records the predecessor timing after candidate code runs",
        "status page without sealed predecessor timing",
    ),
    (
        site_dir / "status" / "index.html",
        "Revision, benchmark-contract, artifact-identity, and",
        "Revision and comparison differences are tolerated, and",
        "status page without fail-closed paired evidence",
    ),
    (
