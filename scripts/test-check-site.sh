...
mutations = (
    ...
    (
        ...
        "This gate keeps a reusable bootstrap:",
        "status page with a reusable performance bootstrap",
    ),
    (
        site_dir / "status" / "index.html",
        "from the exact successful <code>main</code> predecessor",
        "from any available <code>main</code> run",
        "status page without exact-predecessor provenance",
    ),
    (
        site_dir / "status" / "index.html",
        "and fails closed when that baseline is unavailable.",
        "and continues when that baseline is unavailable.",
        "status page without fail-closed baseline handling",
    ),
    (
