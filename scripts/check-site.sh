...
PAGE_SPECS = {
    "status": {
        ...
        "required_visible_text": (
            ...
            "The frontend performance gate runs independently of that compiler sequence",
            "every pull request performs the required frontend measurement and fails on a regression greater than 2%",
            "against the non-expired artifact from its exact successful main predecessor",
            "There is no missing-baseline bootstrap.",
        ),
    },
    "architecture": {
