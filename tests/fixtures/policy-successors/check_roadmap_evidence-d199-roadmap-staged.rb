...
# (hermetic Lighthouse 12.8.2 accessibility gate) and its ci-gate.needs /
# fail-step wiring. Coexists with D100/D112/D114/D229 until a later round
# retires them, mirroring this array's own coexist-then-retire precedent.
# Not yet active: this array entry only authorizes the shape for a future
# ci.yml activation (a later, separate round) -- the live ci.yml is
# untouched by this staging round.
D199_PAGES_ACCESSIBILITY_CI_WORKFLOW_SHA256 =
  "a4c34779e205b117702876e9461937386efa146ff1ed343ea094c82e5d0c6e1b"
