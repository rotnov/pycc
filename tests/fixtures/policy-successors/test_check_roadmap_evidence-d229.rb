...
class RoadmapEvidenceCliTest < Minitest::Test
  ...
  # ci.yml now matches D229 (Phase 3 activation, issue #229) -- D100/D112
  ...
  # coexist-then-retire precedent for this exact array. D-229 is now the
  ...
  # Issue #229 (Phase 3): the D229 pages-performance digest is now the
  # live ci.yml shape (Phase 3 activation has landed), authorizing the
  ...
  # explicit "7.0" threshold_percent argument -- is now a retained,
  # no-longer-live audit shape (D229 is now the live
  # `.github/workflows/ci.yml` shape, see
  # test_tier1_workflow_authorization_is_the_active_d229_digest above);
  # D114 remains accepted in the reviewed array only as retained audit
  # evidence.
  ...
  # shape, now a retained, no-longer-live audit shape -- D229 is now the
  # live `.github/workflows/ci.yml` shape, see
  # test_tier1_workflow_authorization_is_the_active_d229_digest above).
