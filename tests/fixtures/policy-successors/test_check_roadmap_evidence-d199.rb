...
class RoadmapEvidenceCliTest < Minitest::Test
  ...
  # is now the live ci.yml shape.  Issue #199 (D-103 stage): the D199
  # pages-accessibility digest is staged alongside it.
  ...
  def test_d199_pages_accessibility_workflow_is_not_the_live_ci_yml
    # The D199 fixture must differ from the live ci.yml (D229 shape).
