...
<!-- evidence-hero: architecture | architecture-trace-v1 | compiler-pipeline-trace | partial | /architecture/ -->
architecture-trace-v1 — partial: tests/fixtures/quick_start.py traced through parser, HIR, type checking, MIR and a native build to a 26-byte stdout; LLVM IR unavailable. Re-derived by tests/architecture_trace.rs (parser e3bab36a048cba708813e94e39a0301cc4dc4934bd14d9b8fc7101a5028cf45e, HIR 8e92d002b5438d4cf8b41d2390ad1f37679a4d43c76bc1e357963ded2594c84c, MIR dc6b710e2975df6b718f2fb30d48cef4b2738d3544fecdf4b50ba826320f3d7e). One fixture is not the language. The LLVM IR stage carries no artifact at all, because pycc has no --emit flag, so this trace is partial and never all-Tier-1. The parser, HIR and MIR artifacts are Rust Debug renderings: a developer-facing format with no stability guarantee, so their SHA-256 identities change whenever those types change. The native build and its stdout were observed on one host; tests/architecture_trace.rs re-derives every stage wherever cargo test --workspace runs. [Exact stage artifacts, SHA-256 identities and excerpts](https://rotnov.github.io/pycc/architecture/).
<!-- evidence-hero: status | status-snapshot-v1 | required-checks-snapshot | all-Tier-1 | /status/ -->
status-snapshot-v1 — all-Tier-1: main 4111208c0910c0a7588408a6ac7d2b2bad20592c (PR #1005 head 984eb6f27ca9f4809fa1277e12f8c83283bef1f6) — ci-gate success, audit success, five Tier-1 jobs success; captured 2026-09-11T16:48:51Z. A point-in-time observation of one default-branch revision; later merges are not covered until the snapshot is refreshed. all-Tier-1 means the listed jobs concluded success in that run, not release readiness. The merged pull request's head commit is not reachable from a clean checkout, so its tree equality is proven from the collector's recorded fields, not from Git. [Exact subjects, run and job links](https://rotnov.github.io/pycc/status/).
